...
- User-facing data content MUST be in Croatian (`hr-HR`) (for example catalog display text, end-user labels, human-visible item content).
- Keep raw source fields unchanged (for example chain item names), unless there is an explicit normalization/mapping rule.
