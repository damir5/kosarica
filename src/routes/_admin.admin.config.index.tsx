...
function AdminConfigPage() {
	...
	const [clientRuntimeConfig, setClientRuntimeConfig] = useState<Record<
		string,
		string
	> | null>(null);
	...
	useEffect(() => {
		if (typeof window !== "undefined") {
			...
			Object.keys(clientConfig)
				...
				.forEach((key) => {
					config[key] =
						(clientConfig as Record<string, string>)[key] || "Not set";
				});
								...
								<div className="space-y-3">
									{Object.entries(data.serverConfig)
										...
										.map(([key, value]) => (
											<div
												key={key}
												className="flex flex-col gap-1 border-border border-b pb-3 last:border-b-0"
											>
