							...
							onSave={async (data) => {
								await updateMutation.mutateAsync({
									requireEmailVerification:
										data.requireEmailVerification ?? undefined,
									minPasswordLength: data.minPasswordLength ?? undefined,
									maxPasswordLength: data.maxPasswordLength ?? undefined,
									passkeyEnabled: data.passkeyEnabled ?? undefined,
								});
							}}
							isLoading={updateMutation.isPending}
						/>
