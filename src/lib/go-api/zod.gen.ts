...
export const zHandlersIngestionChunk = z.object({
	chunkIndex: z.optional(z.int()),
	createdAt: z.optional(z.string()),
	endRow: z.optional(z.int()),
	errorCount: z.optional(z.int()),
	fileId: z.optional(z.string()),
	id: z.optional(z.string()),
	persistedCount: z.optional(z.int()),
	processedAt: z.optional(z.string()),
	r2Key: z.optional(z.string()),
...
export const zHandlersIngestionStoreStats = z.object({
	failedRows: z.optional(z.int()),
	fileCount: z.optional(z.int()),
	persistedCount: z.optional(z.int()),
	priceChanges: z.optional(z.int()),
	rowCount: z.optional(z.int()),
	storeCity: z.optional(z.string()),
	storeId: z.optional(z.string()),
	storeIdentifier: z.optional(z.string()),
...
export const zHandlersListChunksResponse = z.object({
	chunks: z.optional(z.array(zHandlersIngestionChunk)),
...
export const zHandlersListStoreStatsResponse = z.object({
	stores: z.optional(z.array(zHandlersIngestionStoreStats)),
	total: z.optional(z.int()),
});
 ...
 * Cache health status
 */
export const zGetInternalBasketCacheHealthResponse = z.record(
	z.string(),
	z.unknown(),
);
 ...
 * Cache refreshed
 */
export const zPostInternalBasketCacheRefreshByChainSlugResponse = z.record(
	z.string(),
	z.unknown(),
);
 ...
 * Cache warmed up
 */
export const zPostInternalBasketCacheWarmupResponse = z.record(
	z.string(),
	z.unknown(),
);
 ...
 * OK
 */
export const zPostInternalBasketOptimizeMultiResponse =
 ...
 */
export const zPostInternalBasketOptimizeSingleResponse = z.record(
	z.string(),
	z.unknown(),
);

export const zGetInternalIngestionFilesByFileIdData = z.object({
	body: z.optional(z.never()),
	path: z.object({
		fileId: z.string(),
	}),
 ...
 * OK
 */
export const zGetInternalIngestionFilesByFileIdResponse =
	zHandlersIngestionFile;

export const zGetInternalIngestionFilesByFileIdChunksData = z.object({
	body: z.optional(z.never()),
	path: z.object({
		fileId: z.string(),
	}),
 ...
 * OK
 */
export const zGetInternalIngestionFilesByFileIdChunksResponse =
	zHandlersListChunksResponse;

export const zGetInternalIngestionFilesByFileIdErrorsData = z.object({
	body: z.optional(z.never()),
	path: z.object({
		fileId: z.string(),
	}),
 ...
 * OK
 */
export const zGetInternalIngestionFilesByFileIdErrorsResponse =
	zHandlersListErrorsResponse;

export const zGetInternalIngestionFilesByFileIdStoresData = z.object({
	body: z.optional(z.never()),
	path: z.object({
		fileId: z.string(),
	}),
 ...
 * OK
 */
export const zGetInternalIngestionFilesByFileIdStoresResponse =
...
export const zGetInternalIngestionRunsData = z.object({
	...
	query: z.optional(
		z.object({
			chainSlug: z.optional(z.string()),
			status: z.optional(z.enum(["pending", "running", "completed", "failed"])),
 ...
 * Run deleted
 */
export const zDeleteInternalIngestionRunsByRunIdResponse = z.record(
	z.string(),
	z.unknown(),
);
 ...
 * OK
 */
export const zGetInternalIngestionRunsByRunIdErrorsResponse =
	zHandlersListErrorsResponse;
 ...
 * OK
 */
export const zGetInternalIngestionRunsByRunIdFilesResponse =
 ...
 * Rerun created
 */
export const zPostInternalIngestionRunsByRunIdRerunResponse = z.record(
	z.string(),
	z.unknown(),
);

export const zGetInternalIngestionRunsByRunIdStoresData = z.object({
	body: z.optional(z.never()),
	path: z.object({
		runId: z.string(),
	}),
 ...
 * OK
 */
export const zGetInternalIngestionRunsByRunIdStoresResponse =
	zHandlersListStoreStatsResponse;
 ...
 * OK
 */
export const zGetInternalPricesByChainSlugByStoreIdResponse =
