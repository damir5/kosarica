...
export function StoreForm({
	...
	const id = useId();
	const storeNameId = `${id}-store-name`;
	const storeAddressId = `${id}-store-address`;
	const storeCityId = `${id}-store-city`;
			...
			<div className="space-y-4">
				...
				<div className="space-y-3 pl-8">
					...
					<div className="space-y-1.5">
						<label htmlFor={storeNameId} className="text-sm font-medium">
							Name
						</label>
						<Input
							id={storeNameId}
					...
					{/* Address */}
					<div className="space-y-1.5">
						<label htmlFor={storeAddressId} className="text-sm font-medium">
							Address
						</label>
						<Input
							id={storeAddressId}
					...
					{/* City */}
					<div className="space-y-1.5">
						<label htmlFor={storeCityId} className="text-sm font-medium">
							City
						</label>
						<Input
							id={storeCityId}
					...
					{/* Geo Coordinates */}
					<div className="space-y-1.5">
						<div className="text-sm font-medium">Geo Coordinates</div>
						<div className="flex items-center gap-2">
							<Input
								value={data.latitude}
			...
			<div className="space-y-4">
				...
				<div className="space-y-4 pl-8">
					...
					{data.pricingMode === "inherited" && (
						<div className="space-y-1.5">
							<div className="text-sm font-medium">Select Source</div>
							<PriceSourceSelect
								chainSlug={chainSlug}
								value={data.priceSourceStoreId}
								onValueChange={(value) =>
									updateField("priceSourceStoreId", value)
								}
							/>
