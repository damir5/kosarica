...
interface VerifyLocationModalProps {
  ...
  onAccept: (taskId: string, corrections?: Record<string, unknown>) => Promise<void>
          ...
          {task.type === 'geocode' && outputData && !outputData.found && (
            <div className="rounded-md bg-muted p-4">
              <p className="text-sm text-muted-foreground">
                No geocoding results were found for this address. You can manually
                enter coordinates or reject this task.
              </p>
          ...
          {task.type === 'verify_address' && outputData && (
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-sm">{outputData.originalAddress || 'Not set'}</p>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm">{outputData.postalCode || 'Not set'}</p>
                </div>
              </div>
            </div>
          )}
