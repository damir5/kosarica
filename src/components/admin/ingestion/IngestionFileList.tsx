					...
					{files.map((file) => {
						...
						return (
							<TableRow key={file.id}>
								...
								<TableCell>
									<span
										className={`px-2 py-0.5 rounded text-xs font-medium ${FILE_TYPE_COLORS[file.fileType.toLowerCase()] || "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300"}`}
									>
