...
const LeafletTooltip = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.Tooltip }))
)
const LeafletCircle = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.Circle }))
)
const LeafletCircleMarker = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.CircleMarker }))
)
const LeafletPolyline = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.Polyline }))
)
const LeafletPolygon = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.Polygon }))
)
const LeafletRectangle = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.Rectangle }))
)
const LeafletLayerGroup = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.LayerGroup }))
)
const LeafletFeatureGroup = lazy(
    () => import("react-leaflet").then((m) => ({ default: m.FeatureGroup }))
)
const LeafletMarkerClusterGroup = lazy(
    () => import("react-leaflet-markercluster").then((m) => ({ default: m }))
    ...
    return (
        <Suspense
            fallback={
                <div
                    className={cn(
                        "z-50 size-full min-h-96 flex-1 rounded-md bg-muted animate-pulse",
                        className
                    )}
                />
            }
