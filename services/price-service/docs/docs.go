            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.ListChunksResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.ListStoreStatsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "handlers.ListChunksResponse": {
            ...
            "properties": {
                "chunks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.IngestionChunk"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "handlers.ListStoreStatsResponse": {
            ...
            "properties": {
                "stores": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.IngestionStoreStats"
                    }
                },
                "total": {
                    "type": "integer"
